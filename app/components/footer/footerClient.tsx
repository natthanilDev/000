        ...
        <div className="container-footer">
          ...
          <div className="footer-box" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
            ...
            <div className="contentFooter-box">
              ...
              <h6 className='jiei-footer page-425' itemProp="name">JIEI (THAILAND) CO., LTD.</h6>
              <p className='jiei-footer page-425' itemProp="streetAddress">
              ...
              <p className='jiei-footer page-425'>{lang === ('th') ? "เวลาทำการ : " : lang === ('en') ? "Opening Hours : " : "営業時間 ："}<time itemProp="openingHours" dateTime="Mo-Fr 08:00-17:00">{lang === ('th') ? "จันทร์ - ศุกร์ เวลา 8.00 - 17.00 น." : lang === ('en') ? "Mon - Fri, 8:00 AM - 5:00 PM" : "月曜日〜金曜日 8:00〜17:00"}</time></p>
