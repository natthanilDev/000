...
export default function ImageDescription() {
    ...
    const content_supportTH = [
        "บริษัทของเรา JIEI (ไทยแลนด์) ได้ผลิตและส่งออกผลิตภัณฑ์ไปทั่วโลก โดยนำเสนอผลิตภัณฑ์ยางหลากหลายประเภทสำหรับวัสดุก่อสร้าง ยานยนต์ และการใช้งานในอุตสาหกรรมอื่น ๆ",
    ...
    const content_supportJP = [
        "当社 JIEI（THAILAND）CO.,LTDは、ゴム製品を製造し、世界各国へ輸出しており、自動車用途、その他さまざまな産業用途向けに多様なゴム製品を提供いたします。",
        "当社の高精度技術は独自の手法を活用しており、美しく快適な車両の創造を支援する実績があります。",
        "お客様のニーズに応えることを使命とし、常に最新の最先端技術を取り入れています。",
        "豊富な経験に基づく設計計画や製品開発から、産業的手法による量産まで、一貫したサポートを提供しています。"
    ]
  return (
    <div>
