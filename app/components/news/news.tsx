...
//     `,
    ...
    `
      ...
      <div>
      <p>
      JIEI（Thailand）Co., Ltd. のスポーツデーは、2025年12月9日、15日、18日に開催されます。社員同士の団結力向上、健康促進、そして職場の活気づくりを目的としたイベントです。各チームが様々な競技に元気よく参加し、応援団の盛り上がりとともに、会場は終始にぎやかで楽しい雰囲気に包まれます。
      </p>
