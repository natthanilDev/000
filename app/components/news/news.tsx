    ...
    <div className='news-bg'>
      ...
      {selectedNews === null ? (
        <>
          <ScrollReveal>
            ...
            <div className="news-text-description-box">
              <p className='activities-text-description'>{lang===('th') ? "เราอัปเดตข้อมูลเกี่ยวกับนวัตกรรม เทคโนโลยีของบริษัทอย่างต่อเนื่อง เพื่อให้คุณไม่พลาดความเคลื่อนไหวสำคัญในอุตสาหกรรมและการพัฒนาของเรา" 
              : lang===('en') ? "We continuously update information about the company’s innovations and technologies to ensure you never miss important industry trends and our developments." 
                    ...
                    <div className="product-description-box">
                      <div className="space-part-box">
                        ...
                        <p className='space-part'>
                          {lang===('th') ? revContentTH[start + index] : lang===('en') ? revContentEN[start + index] : revContentJP[start + index]}
                        </p>
                      </div>
        ...
        <div className="detail-news">
          <ScrollReveal>
            <h2 className='title-news-page'>{lang===('th') ? revNewsTH[selectedNews] : lang===('en') ? revNewsEN[selectedNews] : revNewsJP[selectedNews]}</h2>
            <div className="line"></div>
            <Image
